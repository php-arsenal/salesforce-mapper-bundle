...
namespace LogicItLab\Salesforce\MapperBundle\Tests;
...
use LogicItLab\Salesforce\MapperBundle\Events;
use LogicItLab\Salesforce\MapperBundle\Tests\Mock;
...
class MapperTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        return;
        $client = $this->getMockBuilder('LogicItLab\Salesforce\ClientBundle\Client')
    ...
    protected function getMapper($client)
    {
        ...
        $cache = $this->getMockBuilder('LogicItLab\Salesforce\MapperBundle\Cache\FileCache')
            ->disableOriginalConstructor()
            ->getMock();
